		...
		<div class="">
			<div class="hero med-marg-bot">
				...
				<div class="input-wrapper-split"> 
					<a href="#list" type="submit" class="cta-button center-text card bread-txt">Find a lawyer</a>
					...
					<?php 
						if (isset($user)) { 
							if ($user['usertype'] == 0) { 
								...
								$questionquery = mysqli_fetch_array($query);
								$question = $questionquery[0];
								echo $question;
									if ($question == 0) {	
									?>
									<a href="question.php" class="cta-button center-text card bread-txt marg-container">Ask a free Question</a>
						<?php }}} ?>
				</div>	
				</div>
			</div>
			...
			<div class="lawyer-listing container center-marg">
				...
				<div class="search container med-marg-bot">
					...
					<!--SEARCH FUNCTION-->
					<form action="index.php" class="full-w full-h card" method="POST">
